...
const INCOMES = [
  {
    ...
    amount: 5800,
    date: "2026-01-10",
    desc: "Wypłata styczeń — Jacek",
  },
  {
    cat: "Wynagrodzenie",
    amount: 4500,
    date: "2026-01-10",
    desc: "Wypłata styczeń — Ola",
  },
  {
    cat: "Wynagrodzenie",
    amount: 5800,
    date: "2026-02-10",
    desc: "Wypłata luty — Jacek",
  },
  {
    cat: "Wynagrodzenie",
    amount: 4500,
    date: "2026-02-10",
    desc: "Wypłata luty — Ola",
  },
  { cat: "Premia", amount: 3000, date: "2026-02-15", desc: "Premia kwartalna" },
  {
    ...
    amount: 5800,
    date: "2026-03-10",
    desc: "Wypłata marzec — Jacek",
  },
  {
    cat: "Wynagrodzenie",
    amount: 4500,
    date: "2026-03-10",
    desc: "Wypłata marzec — Ola",
  },
  { cat: "Sprzedaż", amount: 800, date: "2026-03-22", desc: "Sprzedaż na OLX" },
  {
    ...
    amount: 5800,
    date: "2026-04-10",
    desc: "Wypłata kwiecień — Jacek",
  },
  {
    cat: "Wynagrodzenie",
    amount: 4700,
    date: "2026-04-10",
    desc: "Wypłata kwiecień — Ola (podwyżka)",
  },
  {
    cat: "Inwestycje & dywidendy",
    amount: 420,
    date: "2026-04-05",
    desc: "Dywidenda XTB",
  },
...
const EXPENSES = [
  ...
  },
  {
    ...
    amount: 180,
    date: "2026-01-14",
    desc: "Wizyta lekarska + leki",
  },
  {
    cat: "Sport",
    amount: 150,
    date: "2026-01-02",
    desc: "Siłownia — abonament",
  },
  {
    cat: "Rozrywka",
    amount: 220,
    date: "2026-01-19",
    desc: "Restauracja, kino",
  },
  { cat: "Inne", amount: 95, date: "2026-01-27", desc: "Drobne zakupy" },
  {
    ...
    amount: 2400,
    date: "2026-02-05",
    desc: "Czynsz + media luty",
  },
  {
    cat: "Żywność",
    amount: 590,
    date: "2026-02-07",
    desc: "Biedronka, Carrefour",
  },
  {
    cat: "Żywność",
    amount: 310,
    date: "2026-02-18",
    desc: "Zakupy tygodniowe",
  },
  {
    cat: "Żywność",
    amount: 420,
    date: "2026-02-14",
    desc: "Walentynkowa kolacja",
  },
  ...
  },
  {
    ...
    amount: 280,
    date: "2026-04-06",
    desc: "Wielkanocny wyjazd",
  },
  {
    cat: "Zdrowie",
    amount: 120,
    date: "2026-04-03",
    desc: "Apteka, suplementy",
  },
  {
    cat: "Elektronika",
    amount: 499,
    date: "2026-04-12",
    desc: "Klawiatura mechaniczna",
  },
  {
    cat: "Prezenty",
    amount: 160,
    date: "2026-04-15",
    desc: "Prezent urodzinowy",
  },
];

const DEPOSITS = [
  {
    acc: "Konto mieszkaniowe Ola",
    amount: 500,
    date: "2026-01-12",
    desc: "Comiesięczna wpłata",
  },
  {
    acc: "Konto mieszkaniowe Jacek",
    amount: 500,
    date: "2026-01-12",
    desc: "Comiesięczna wpłata",
  },
...
const WITHDRAWAL = {
  ...
  amount: 1200,
  date: "2026-03-10",
  desc: "Wypłata z lokaty na remont",
};
...
const SNAPSHOTS = [
  ...
  },
  {
    ...
    balance: 15210,
    date: "2026-04-15",
    note: "Wzrost po korekcie",
  },
  {
    acc: "Freedom24 Jacek",
    balance: 13950,
    date: "2026-04-15",
    note: "Po zakupie + wzrost",
  },
  {
    acc: "Lokaty Ola & Jacek",
    balance: 17120,
    date: "2026-04-15",
    note: "Odsetki kwartalne",
  },
];

async function getOrCreateExpenseCat(name) {
...
async function getOrCreateIncomeCat(name) {
  const { data } = await supabase
...
export async function seedDemoData() {
  ...
  for (const a of DEMO_ACCOUNTS) {
    await supabase
      ...
      .insert({ name: a.name, color: a.color, is_demo: true });
  }
  ...
  // Wpływy (twórz kategorie jeśli brak)
  for (const i of INCOMES) {
    const catId = await getOrCreateIncomeCat(i.cat);
    await supabase
      .from("incomes")
      .insert({
        description: i.desc,
  ...
  // Wydatki (twórz kategorie jeśli brak)
  for (const e of EXPENSES) {
    const catId = await getOrCreateExpenseCat(e.cat);
    await supabase
      .from("expenses")
      .insert({
        description: e.desc,
  ...
  if (savAccs[WITHDRAWAL.acc]) {
    const { data: wOp } = await supabase
      ...
      .insert({
        account_id: savAccs[WITHDRAWAL.acc],
        type: "withdrawal",
    ...
    if (wOp) {
      await supabase.from("incomes").insert({
        description: WITHDRAWAL.desc,
        category_id: withdrawalCatId,
        amount: WITHDRAWAL.amount,
        date: WITHDRAWAL.date,
        savings_operation_id: wOp.id,
        is_demo: true,
      });
    }
  }
