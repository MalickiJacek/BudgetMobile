...
export default function ExpensesScreen() {
  ...
  const confirmReassign = async () => {
    ...
    await reassignExpensesCategory(deletingCat.id, reassignTarget);
              ...
              <>
                <View style={s.infoBox}>
                  <Text style={s.infoText}>
                    Kategoria „{deletingCat.name}" ma {deletingCat.cnt} wydatk{deletingCat.cnt === 1 ? '' : deletingCat.cnt < 5 ? 'i' : 'ów'}.{'\n'}
                    Wybierz kategorię, na którą przepiąć te wydatki:
                  </Text>
                </View>
                <ScrollView style={{ flex: 1 }}>
